...
assert.equal(marketplace.owner?.name, "Tabula", "Marketplace owner name must be present.");
assert.equal(marketplace.description, "Connect Claude Code to shared Tabula Markdown workspaces.");
...
assert.equal(marketplacePlugin.description, "Connect Claude Code to shared Tabula Markdown workspaces.");
...
assert.equal(plugin.author?.name, "Tabula", "Plugin author name must be present.");
assert.equal(plugin.description, "Connect Claude Code to shared Tabula Markdown workspaces.");
