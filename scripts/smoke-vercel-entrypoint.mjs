...
assert(healthBody.version === "0.2.2", "Vercel health did not expose the package version");
...
assert(readyBody.version === "0.2.2", "Vercel ready did not expose the package version");
