...
assert(healthBody.version === "0.8.1", "Vercel health did not expose the package version");
...
assert(readyBody.version === "0.8.1", "Vercel ready did not expose the package version");
