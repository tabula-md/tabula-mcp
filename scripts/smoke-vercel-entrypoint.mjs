...
assert(healthBody.version === "0.6.0", "Vercel health did not expose the package version");
...
assert(readyBody.version === "0.6.0", "Vercel ready did not expose the package version");
