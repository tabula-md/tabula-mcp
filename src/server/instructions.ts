...
export const createCoreInstructions = ({
  ...
  "Read existing files with Read Files before changing them and pass their revisions to Write Files, Edit File, Move or Rename, or Delete Path.",
  ...
  "Use Edit File for small exact replacements instead of rewriting a complete file.",
