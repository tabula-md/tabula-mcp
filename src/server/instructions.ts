...
export const createCoreInstructions = ({
  ...
  "A successful file or comment mutation result is authoritative. Do not read or list again only to verify it; refresh after a stale conflict, a later collaborator change, an incomplete result, or an explicit user request.",
