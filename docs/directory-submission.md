...
- MCPB artifact: `dist/tabula-mcp-0.1.1.mcpb`
...
1. Publish the matching `@tabula-md/mcp@0.1.1` npm release before distributing
...
4. Submit the local `dist/tabula-mcp-0.1.1.mcpb` through the Desktop Extension
