...
Claude can also list open or resolved comments, add file-level or line-anchored
comments, reply, resolve or reopen threads, and permanently delete a thread
when asked.
...
reloads the twenty core tool definitions.
